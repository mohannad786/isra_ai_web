...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-2 py-3 lg:px-4 lg:py-4">
      <div className={`container mx-auto rounded-full transition-all duration-300 transform scale-95 md:scale-80 lg:scale-75 ${scrolled
